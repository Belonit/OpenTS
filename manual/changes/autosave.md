...
`AUTOSAVE_SKIRMISH5.SAV`; a client-launched game against other machines writes
`SAVEGAME.NET` on every machine at the same frame. A game started from the menu takes its
